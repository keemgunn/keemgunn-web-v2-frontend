...
<g id="g-eye" :class="g_eye">
  ...
  <g id="p-eye-1">
    <g>
      ...
      <path :class="p_eye" d="M12 4.5C7 4.5 2.73 7.61 1 12C2.73 16.39 7 19.5 12 19.5C17 19.5 21.27 16.39 23 12C21.27 7.61 17 4.5 12 4.5Z" stroke="var(--ink1)" stroke-width="3.2" mask="url(#path-1-inside-1_201:983)"/>
    </g>
  </g>
  ...
  <g id="p-eye-2">
    <g>
      ...
      <path :class="p_eye" d="M12 4.5C7 4.5 2.73 7.61 1 12C2.73 16.39 7 19.5 12 19.5C17 19.5 21.27 16.39 23 12C21.27 7.61 17 4.5 12 4.5Z" stroke="var(--ink1)" stroke-width="3.2" mask="url(#path-2-inside-2_201:983)"/>
    </g>
  </g>
  ...
  <g id="p-eye-3">
    <g>
      ...
      <path :class="p_eye" d="M12 4.5C7 4.5 2.73 7.61 1 12C2.73 16.39 7 19.5 12 19.5C17 19.5 21.27 16.39 23 12C21.27 7.61 17 4.5 12 4.5Z" stroke="var(--ink1)" stroke-width="3.2" mask="url(#path-3-inside-3_201:983)"/>
    </g>
  </g>
  ...
  <g id="p-eye-4">
    <g>
      ...
      <path :class="p_eye" d="M12 4.5C7 4.5 2.73 7.61 1 12C2.73 16.39 7 19.5 12 19.5C17 19.5 21.27 16.39 23 12C21.27 7.61 17 4.5 12 4.5Z" stroke="var(--ink1)" stroke-width="3.2" mask="url(#path-4-inside-4_201:983)"/>
    </g>
  </g>
...
<g id="g-cover" :class="g_cover">
  <circle id="p-cover" :class="p_cover" cx="12" cy="12" r="1" fill="var(--ink6)"/>
</g>
...
<g id="g-pupil" :class="g_pupil">
  <g id="p-pupil">
    ...
    <path :class="p_pupil" d="M16 12C16 14.2091 14.2091 16 12 16C9.79086 16 8 14.2091 8 12C8 9.79086 9.79086 8 12 8C14.2091 8 16 9.79086 16 12Z" stroke="var(--ink1)" stroke-width="3.2" mask="url(#path-6-inside-5_201:983)"/>
  </g>
</g>
...
<g id="g-moon" :class="g_moon">
  <g id="p-moon">
    ...
    <path :class="p_moon" d="M12.083 9C12.6441 9 13.1713 9.15 13.6245 9.405C12.7027 9.924 12.083 10.89 12.083 12C12.083 13.11 12.7027 14.076 13.6245 14.595C13.1713 14.85 12.6441 15 12.083 15C10.3812 15 9 13.656 9 12C9 10.344 10.3812 9 12.083 9Z" stroke="var(--ink1)" stroke-width="0" mask="url(#path-7-inside-6_201:983)"/>
  </g>
</g>
